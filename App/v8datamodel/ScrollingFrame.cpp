...
namespace ARL
{
    ...
    ScrollingFrame::ScrollingFrame()
        ...
        , topImage(TextureId("arlasset://textures/ui/Scroll/scroll-top.png"))
        , midImage(TextureId("arlasset://textures/ui/Scroll/scroll-middle.png"))
        , bottomImage(TextureId("arlasset://textures/ui/Scroll/scroll-bottom.png"))
