...
struct InsertObjectItem
{
	...
	InsertObjectItem(std::string contentId, std::vector<weak_ptr<ARL::Instance> > weakInstances)
	{
...
public:
    ...
    void setGridMode(ARL::DRAG::DraggerGridMode gridMode);
	...
	void trackToolboxInserts(ARL::ContentId contentId, const ARL::Instances& instances);
...
private:
	...
	void checkInternetConnectionSendCounter(ARL::Http& robloxRequest, ARL::Http& externalRequest);
    ...
    ARL::BaldPtr<InsertServiceDialog>           m_pInsertServiceDlg;
    ARL::BaldPtr<RobloxSettingsDialog>          m_pSettingsDialog;
    ARL::BaldPtr<ShortcutHelpDialog>            m_pShortcutHelpDialog;
    ARL::BaldPtr<RobloxInputConfigDialog>       m_pInputConfigDialog;
    ARL::BaldPtr<QSplashScreen>                 m_splashScreen;
