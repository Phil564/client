...
void RobloxUser::currentUserReplied(ARL::HttpFuture future)
{
	try {
...
void RobloxUser::getWebkitUserId()
{
    ...
    m_webKitUserIDQuery = ARL::HttpAsync::get(url).then(boost::bind(&RobloxUser::currentUserReplied, this, _1));
}
