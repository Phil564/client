...
function initializeDeveloperConsole()
	...
	Create'ImageLabel'{
		...
		Image = "arlasset://textures/devconsole/legacy/handle.png";
	}
	...
	Create'ImageLabel'{
		...
		Rotation = 180;
		Image = "arlasset://textures/devconsole/legacy/down.png";
	}
	...
	Create'ImageLabel'{
		...
		Size = UDim2.new(1, 0, 1, 0);
		Rotation = 0;
		Image = "arlasset://textures/devconsole/legacy/options.png";
	}
	...
	Create'ImageLabel'{
		...
		Position = UDim2.new(0, 3, 0, 3);
		Size = UDim2.new(0, 14, 0, 14);
		Image = "arlasset://textures/devconsole/legacy/close.png";
	}
