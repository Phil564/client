...
function initializeDeveloperConsole()
	...
	Create'ImageLabel'{
		...
		Image = "http://arl.lambda.cam/Asset?id=151205881";
	}
	...
	Create'ImageLabel'{
		...
		Rotation = 180;
		Image = "http://arl.lambda.cam/Asset?id=151205813";
	}
	...
	Create'ImageLabel'{
		...
		Size = UDim2.new(1, 0, 1, 0);
		Rotation = 0;
		Image = "http://arl.lambda.cam/Asset?id=152093917";
	}
	...
	Create'ImageLabel'{
		...
		Position = UDim2.new(0, 3, 0, 3);
		Size = UDim2.new(0, 14, 0, 14);
		Image = "http://arl.lambda.cam/Asset?id=151205852";
	}
