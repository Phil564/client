...
local function Initialize()
	...
	local function createPCHelp(parentFrame)
		...
		local menuFrame = createPCGroup("Menu Items", {		[1] = {["ANORRL Menu"] = "ESC"}, 
														 	[2] = {["Backpack"] = "~"},
															[3] = {["Playerlist"] = "TAB"},
															[4] = {["Chat"] = "/"} })
	...
	local function createGamepadHelp(parentFrame)
		...
		if gamepadImage == "arlasset://textures/ui/Settings/Help/XboxController.png" then
			...
			createGamepadLabel("ANORRL Menu", UDim2.new(0.96,0,0.15,-textVerticalSize/2), UDim2.new(0,122,0,textVerticalSize))
			...
			createGamepadLabel("Use Tool", UDim2.new(0.96,0,0,-textVerticalSize/2), UDim2.new(0,73,0,textVerticalSize))
			createGamepadLabel("ANORRL Menu", UDim2.new(0.9,0,0.15,-textVerticalSize/2), UDim2.new(0,122,0,textVerticalSize))
